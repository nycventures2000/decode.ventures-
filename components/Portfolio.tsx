      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            ...
            >
              ...
              <div className="relative border-[3px] border-white/10 group-hover:border-orange-500 transition-colors duration-700 px-8 md:px-12 py-10 md:py-14 bg-white/5 backdrop-blur-sm">
                <h3 className="text-5xl md:text-7xl font-display font-bold uppercase leading-tight text-white group-hover:text-orange-500 transition-colors duration-500">
                  GET IN <br/> <span className="text-orange-500 group-hover:text-white transition-colors duration-500">TOUCH</span>
                </h3>
                <div className="mt-8 flex items-center space-x-4">
                  <div className="h-px w-12 bg-orange-500"></div>
                  <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-400 group-hover:text-white transition-colors">Send Email</span>
                </div>
              </div>
            </a>
          </div>
        ...
        <div className="w-full md:w-1/2 max-w-lg">
          <div className="relative group overflow-hidden rounded-2xl shadow-2xl">
            <img 
              src="https://images.unsplash.com/uploads/1413222992504f1b734a6/1928e537?auto=format&fit=crop&q=80&w=1080" 
              alt="Music Contact" 
